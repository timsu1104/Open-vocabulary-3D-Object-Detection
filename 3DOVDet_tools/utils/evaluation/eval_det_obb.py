...
"""
import numpy as np
from utils.evaluation.box_util import box3d_iou, get_3d_box, flip_axis_to_camera
...
def get_iou_obb(bb1, bb2):
    bb1 = flip_axis_to_camera(bb1)
    bb2 = flip_axis_to_camera(bb2)
    bb1 = get_3d_box(bb1[3:6], bb1[6], bb1[0:3])
    bb2 = get_3d_box(bb2[3:6], bb2[6], bb2[0:3])
